document.addEventListener("DOMContentLoaded", function () {
  ...
  if (!userId) {
    tableBody.innerHTML = "<tr><td colspan='6'>No user specified.</td></tr>";
    return;
  }

  fetch(`../controllers/GetComplaintsController.php?user_id=${userId}`)
    .then(res => res.json())
    .then(data => {
      tableBody.innerHTML = "";
      ...
      data.forEach(complaint => {
        ...
        row.innerHTML = `
          ...
          <td><button class="btn btn-sm btn-danger penalize-btn" data-user="${userId}">Penalize</button></td>
        `;
    ...
    .catch(error => {
      ...
      tableBody.innerHTML = "<tr><td colspan='6'>Error loading complaints.</td></tr>";
    });
});
