                    ...
                    <div class="card shadow-sm" style="cursor: pointer;">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center mb-1">
                                <h6 class="mb-1">Employer: ${item.employer_name}</h6>
                                <a href="profile.php?user_id=${item.employer_id}" class="ms-2 text-dark" data-bs-toggle="tooltip" title="View Profile">
